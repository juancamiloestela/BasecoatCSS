/*! basecoat - v0.0.0 - 2015-08-17 */window.Basecoat = {
	version: "0.0.1",
};
...
/*! peek-js - v0.0.0 - 2015-08-17 *//* TODO: 
...
'use strict';
	...
	function drag(e){
		if (dragging){
			...
			if (Math.abs(delta.y) > Math.abs(delta.x) && !ignoreY){
				dragging = false;
				return;
			}
